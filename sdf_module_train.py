...
learner_args['model_path'] = './model/forests_module/sdf_'+str(learner_args['num_trees'])+'trees_'+str(learner_args['depth'])+'_id'+str(args.id)

device = torch.device("cuda" if use_cuda and torch.cuda.is_available() else 'cpu')

def train_forest(forest):
    writer = SummaryWriter(log_dir='runs/'+'sdf_module_'+str(learner_args['num_trees'])+'trees_'+str(learner_args['depth'])+'_id'+str(args.id))
