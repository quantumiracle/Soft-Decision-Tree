...
nodes_in_heuristic_tree = [
    ...
    [0.25, 0, 0.5, 0, -0.5, -1, 0, 0 ],
    [0.275, -0.5, 0, -0.5, 0,0,0,0],
    [0.025, -0.5, -0.5, -0.5, 0.5, 1, 0, 0],
    [0.525, -0.5, 0.5, -0.5, -0.5, -1, 0, 0],
...
def difference_metric(list1, list2=nodes_in_heuristic_tree, norm=True):
    ...
    for v1 in list1:
        ...
        for v2 in list2:
            ...
            sim_list.append(sim)
        score+=np.min(sim_list)  # should be changed to be mean rather than sum
    return score
