...
learner_args['model_path'] = './model/trees/sdt_'+str(learner_args['lamda'])+'_id'+str(args.id)+'_ppo'
...
def train_tree(tree):
    ...
    writer = SummaryWriter(log_dir='runs/'+'sdt_'+str(learner_args['lamda'])+'_id'+str(args.id)+'_ppo')
