...
learner_args['model_path'] = './model_cartpole/trees/cascade_'+str(learner_args['feature_learning_depth'])+'_'+str(learner_args['decision_depth'])+'_var'+str(learner_args['num_intermediate_variables'])+'_id'+str(args.id)


device = torch.device('cuda' if use_cuda else 'cpu')

def train_tree(tree):
    writer = SummaryWriter(log_dir='runs_cartpole_greedy/'+'cascade_'+str(learner_args['feature_learning_depth'])+'_'+str(learner_args['decision_depth'])+'_var'+str(learner_args['num_intermediate_variables'])+'_id'+str(args.id))
    ...
    # print(data.shape)
    # print(tree.forward(data.to(device)).shape)
...
if __name__ == '__main__':    
    tree = Cascade_DDT(learner_args).to(device)
    train_tree(tree)
